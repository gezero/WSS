...
import cz.peinlich.exam.color.rules.implementation.rules.DoesNotHaveAdjacentStructureOfColor;
...
public class DoesNotHaveAdjacentStructureOfColorTest {
    ...
    public void test_blue_red_neighbors_from_specification_grid() throws IOException {
        ...
        DoesNotHaveAdjacentStructureOfColor rule = new DoesNotHaveAdjacentStructureOfColor(Color.YELLOW,Color.GREEN);
        Map<Cell, String> cellStringMap = rule.executeRule(grid);
        assertThat(cellStringMap.size(),is(0));

         rule = new DoesNotHaveAdjacentStructureOfColor(Color.RED,Color.BLUE);
